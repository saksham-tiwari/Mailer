...
const ChangePassword = () => {
    ...
    const [pass0Err, setPass0Err]= useState(false);
            ...
            <div className={styles.rightBox} style={{top:"20%"}}>
                ...
                <Form className={styles.formAuth} onSubmit={(e)=>formSubmit(e)}>
                    <Form.Group>
                        ...
                        value={oldPass}
                        style={pass0Err?{borderColor:"red", borderWidth:"4px"}:{borderColor:"#253E7E"}}
                        onChange={(e)=>setOldPass(e.target.value)}
                        />
                        {visible0?<VisibilityIcon onClick={()=>setVisible0(prev=>!prev)} className={styles.eyePass} style={{top:"14%"}}/>:<VisibilityOffIcon onClick={()=>setVisible0(prev=>!prev)} className={styles.eyePass} style={{top:"14%"}}/>}
